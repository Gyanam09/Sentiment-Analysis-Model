...
SM_CHANNEL_TRAINING = os.environ.get(
    'SM_CHANNEL_TRAINING', "/opt/ml/imput/data/training")
...
def main():
    ...
    train_loader, val_loader, test_loader = prepare_dataloaders(
        train_cs=os.path.join(args.train_dir, 'train_sent_emo.csv'),
    ...
    print(f"""Training video directory: {os.path.join(args.train_dir, 'train_aplits')}""")
